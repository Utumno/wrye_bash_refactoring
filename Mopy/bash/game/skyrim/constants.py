...
soundsTypes = {
    ...
    b'SNDR': ('category','outputModel','sounds','looping','rumbleSendValue',
             'pctFrequencyShift','pctFrequencyVariance','priority',
             'dbVariance','staticAtten',),
    b'SOPM': ('reverbSendpct','outputType','ch0_l','ch0_r','ch0_c','ch0_lFE',
    ...
    b'TREE': ('harvestSound',),
    b'WATR': ('openSound',),
    b'WEAP': ('pickupSound','dropSound','attackSound','attackSound2D',
...
#------------------------------------------------------------------------------
object_bounds_types = {b'ACTI', b'ADDN', b'ALCH', b'AMMO', b'APPA', b'ARMO', b'ARTO',
                       b'ASPC', b'BOOK', b'CONT', b'DOOR', b'DUAL', b'ENCH', b'EXPL',
                       b'FLOR', b'FURN', b'GRAS', b'HAZD', b'IDLM', b'INGR', b'KEYM',
                       b'LIGH', b'LVLI', b'LVLN', b'LVSP', b'MISC', b'MSTT', b'NPC_',
                       b'PROJ', b'SCRL', b'SLGM', b'SOUN', b'SPEL', b'STAT', b'TACT',
...
_common_entry_types = {b'ALCH', b'AMMO', b'APPA', b'ARMO', b'BOOK', b'INGR', b'KEYM',
                       b'LIGH', b'LVLI', b'MISC', b'SLGM', b'SCRL', b'WEAP'}
cc_valid_types = {
...
# Import Destructible
#------------------------------------------------------------------------------
destructible_types = {b'ACTI', b'ALCH', b'AMMO', b'APPA', b'ARMO', b'BOOK', b'CONT',
                      b'DOOR', b'FLOR', b'FURN', b'KEYM', b'LIGH', b'MISC', b'MSTT',
                      b'NPC_', b'PROJ', b'SCRL', b'SLGM', b'TACT', b'WEAP'}
