...
from ...brec import MelRecord, MelObject, MelGroups, MelStruct, FID, \
    ...
    get_structs, MelOptUInt32Flags, MelModelCompare
...
class MreQust(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelGroups('objectives',
            ...
            MelGroups('targets',
                MelStruct(b'QSTA','iB3s',('alias', None),(targetFlags,'flags'),('unused1',null3)),
                MelConditions(),
            ),
        ),
        ...
        MelGroups(u'qust_aliases',
            ...
            MelGroup('createReferenceToObject',
                ...
                MelStruct(b'ALCA', 'hH', ('alias', None), 'create_target'),
