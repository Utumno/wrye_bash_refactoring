...
statsTypes = {
    ...
    b'ARMA': ('eid', 'weight', 'value', 'health', 'ar'),
    b'ARMO': ('eid', 'weight', 'value', 'health', 'ar'),
    ...
    b'WEAP': ('eid', 'weight', 'value', 'health', 'damage','clipsize',
...
#------------------------------------------------------------------------------
object_bounds_types = {b'ACTI', b'ADDN', b'ALCH', b'AMMO', b'ARMA', b'ARMO', b'ASPC',
                       b'BOOK', b'COBJ', b'CONT', b'CREA', b'DOOR', b'EXPL', b'FURN',
                       b'GRAS', b'IDLM', b'INGR', b'KEYM', b'LIGH', b'LVLC', b'LVLI',
                       b'LVLN', b'MISC', b'MSTT', b'NOTE', b'NPC_', b'PROJ', b'PWAT',
                       b'SCOL', b'SOUN', b'STAT', b'TACT', b'TERM', b'TREE', b'TXST',
                       b'WEAP'}
...
_common_entry_types = {b'ALCH', b'AMMO', b'ARMO', b'BOOK', b'KEYM', b'LVLI', b'MISC',
                       b'NOTE', b'WEAP'}
...
# Import Destructible
#------------------------------------------------------------------------------
destructible_types = {b'ACTI', b'ALCH', b'AMMO', b'ARMO', b'BOOK', b'CONT', b'CREA',
                      b'DOOR', b'FURN', b'KEYM', b'LIGH', b'MISC', b'MSTT', b'NPC_',
                      b'PROJ', b'TACT', b'TERM', b'WEAP'}
