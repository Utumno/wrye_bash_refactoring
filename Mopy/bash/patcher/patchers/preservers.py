...
class _APreserver(ImportPatcher):
    ...
    def __init__(self, p_name, p_file, p_sources):
        ...
        self.srcClasses = set() #--Record signatures actually provided by src
        # mods/files.
        ...
        self.recAttrs_class = {r: collect_attrs(r, a)
    ...
    def _init_data_loop(self, top_grup_sig, srcFile, srcMod, temp_id_data,
        ...
        recAttrs = self.recAttrs_class[top_grup_sig]
    ...
    def initData(self, progress, __attrgetters=attrgetter_cache):
        ...
        loadFactory = LoadFactory(False, by_sig=self.recAttrs_class)
        ...
        for index,srcMod in enumerate(self.srcs):
            ...
            for master in srcInfo.masterNames:
                ...
                for rsig in self.recAttrs_class:
                    ...
                    if rsig not in self.classestemp: continue
